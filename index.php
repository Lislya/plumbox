...
<body>
	...
	<main>
		<!-- Ad Slider -->
		<div class="slider">
			<div class="slide"><img src="img/icon/arrow1.png" class="arrow" id="prev"></div>
			<img src="img/products/slider/bg.jpg" alt="slider" class="img current">
			<img src="img/products/slider/bg_1.jpg" alt="" class="img">
			<img src="img/products/slider/bg_2.jpg" alt="" class="img">
			<img src="img/products/slider/bg_3.jpg" alt="" class="img">
			<img src="img/products/slider/bg_4.jpg" alt="" class="img">
			<div class="slide"><img src="img/icon/arrow.png" class="arrow" id="next"></div>
		</div>
		<!-- shop slots * 6 -->
		<div class="slot_container">
			...
			<input type="button" name="" value="Кнопка">
			</div>
		</div>
	</main>
